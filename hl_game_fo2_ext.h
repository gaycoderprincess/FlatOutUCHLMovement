...
tFO2MaterialMatchup aSurfaces[] = {
		...
		{ 8, FreemanAPI::CHAR_TEX_DIRT }, // Hard (Road)
		{ 9, FreemanAPI::CHAR_TEX_DIRT }, // Hard Mark (Road)
		{ 10, FreemanAPI::CHAR_TEX_DIRT }, // Medium (Road)
		{ 11, FreemanAPI::CHAR_TEX_DIRT }, // Medium Mark (Road)
		{ 12, FreemanAPI::CHAR_TEX_DIRT }, // Soft (Road)
		{ 13, FreemanAPI::CHAR_TEX_DIRT }, // Soft Mark (Road)
		{ 14, FreemanAPI::CHAR_TEX_DIRT }, // Derby Gravel (Road)
		{ 15, FreemanAPI::CHAR_TEX_CONCRETE }, // Derby Tarmac (Road)
		{ 16, FreemanAPI::CHAR_TEX_DIRT }, // Snow (Road)
		{ 17, FreemanAPI::CHAR_TEX_DIRT }, // Snow Mark (Road)
		...
		{ 23, FreemanAPI::CHAR_TEX_DIRT }, // Bank Sand (terrain)
		{ 24, FreemanAPI::CHAR_TEX_DIRT }, // Grass (terrain)
		{ 25, FreemanAPI::CHAR_TEX_DIRT }, // Forest (terrain)
		{ 26, FreemanAPI::CHAR_TEX_DIRT }, // Sand (terrain)
		{ 27, FreemanAPI::CHAR_TEX_CONCRETE }, // Rock (terrain)
		{ 28, FreemanAPI::CHAR_TEX_DIRT }, // Mould (terrain)
		{ 29, FreemanAPI::CHAR_TEX_DIRT }, // Snow  (terrain)
		{ 30, FreemanAPI::CHAR_TEX_DIRT }, // Field  (terrain)
